...
export default async function PrivatePagePreview({ params }: Props) { const { token } = await params; const page = await getPrivatePagePreview(token); if (!page) notFound(); return <PrivatePageRenderer page={page} preview />; }
